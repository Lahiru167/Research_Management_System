...
<body>
    ...
    <div class="container">
                ...
                if ($fileSize < 5000000) {
                    ...
                    if (move_uploaded_file($fileTmpName, $fileDestination)) {
                        ...
                        if (isset($_GET['update_id'])) {
                            ...
                            // Insert new record
                            $sql = "INSERT INTO marketing (`ResearchTitle`, `AuthorName`, `Category`, `Abstract`, `KeyWord`, `File`) 
        ...
        if (isset($_GET['update_id'])) {
            $updateId = $_GET['update_id'];
            $selectQuery = "SELECT * FROM marketing WHERE id = :id";
        ...
        if (isset($_GET['delete_id'])) {
            ...
            $deleteQuery = "DELETE FROM marketing WHERE id = :id";
            try {
