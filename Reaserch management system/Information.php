...
$query = "SELECT * FROM `info`"; // Replace with your actual table name
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h1 class="header">
        Department of <span class="highlight">Information System</span>
      </h1>
      <p class="sub-header">
      ...
      <div class="grid">
        <img src="img/computing.jpg" alt="Technology image" />
        <img src="img/N1.jpg" alt="Illustration" />
        <img src="img/H1.jpeg" alt="AI" />
      </div>
    </div>

    <!-- Research Data Table with PDF Icon Link -->
