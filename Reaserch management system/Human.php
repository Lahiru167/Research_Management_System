...
$query = "SELECT * FROM `human`"; // Replace with your actual table name
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h1 class="header">
        Department of <span class="highlight">Human Resource Management</span>
      </h1>
      <p class="sub-header">
      ...
      <div class="button-container">
        <a href="Login.php" class="button">Get Start Now</a>
        <a href="#" class="button">Learn More</a>
      </div>

      <div class="grid">
        <img src="img/A1.png" alt="Technology image" />
